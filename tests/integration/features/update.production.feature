...
##### Please always order by version number descending #####
  ##### Tests for 10.10.0 should go below #####
  Scenario: Updating an outdated ownCloud 10.10.0 on the production channel
    Given There is a release with channel "production"
    And The received version is "10.10.0"
    When The request is sent
    Then The response is empty

  ##### Tests for 10.9.x should go below #####
  Scenario: Updating an outdated ownCloud 10.9.0 on the production channel
    Given There is a release with channel "production"
    And The received version is "10.9.0"
    When The request is sent
    Then The response is non-empty
    And URL to download is "https://download.owncloud.com/server/stable/owncloud-10.10.0.zip"

  ##### Tests for 10.8.x should go below #####
  Scenario: Updating an outdated ownCloud 10.8.0 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.4.0 on the production channel
    Given There is a release with channel "production"
    And The received version is "10.4.0"
    When The request is sent
    Then The response is non-empty
    And URL to download is "https://download.owncloud.org/community/owncloud-10.4.1.zip"

  ##### Tests for 10.3.x should go below #####
  Scenario: Updating an outdated ownCloud 10.3.2 on the production channel
    Given There is a release with channel "production"
    And The received version is "10.3.2"
    When The request is sent
    Then The response is non-empty
    And URL to download is "https://download.owncloud.org/community/owncloud-10.4.1.zip"

  Scenario: Updating an outdated ownCloud 10.3.0 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.2.1 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.2.0 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.1.1 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.1.0 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 10.0.10 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 9.1.8 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 8.2.11 on the production channel
    Given There is a release with channel "production"
  ...
  Scenario: Updating an outdated ownCloud 8.1.12 on the production channel
    Given There is a release with channel "production"
