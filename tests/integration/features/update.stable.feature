...
##### Please always order by version number descending #####
  ...
  Scenario: Updating an ownCloud 10.3.2 on the stable channel
    Given There is a release with channel "stable"
  ...
  Scenario: Updating an outdated ownCloud 10.1.1 on the stable channel
    Given There is a release with channel "stable"
  ...
  Scenario: Updating an outdated ownCloud 10.0.10 on the stable channel
    Given There is a release with channel "stable"
  ...
  Scenario: Updating an outdated ownCloud 9.1.8 on the stable channel
    Given There is a release with channel "stable"
