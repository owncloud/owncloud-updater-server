...
##### Please always order by version number descending #####
  ##### Tests for 10.10.x should go below #####
  Scenario: Updating an outdated ownCloud 10.10.0 on the beta channel
  ...
  Scenario: Updating an outdated ownCloud 10.9.1 on the beta channel
    Given There is a release with channel "beta"
  ...
  Scenario: Updating an outdated ownCloud 10.9.0 on the beta channel
    Given There is a release with channel "beta"
  ...
  Scenario: Updating an outdated ownCloud 10.8.0 on the beta channel
    Given There is a release with channel "beta"
  ...
  Scenario: Updating an ownCloud 10.3.2 on the beta channel
    Given There is a release with channel "beta"
  ...
  Scenario: Updating an ownCloud 10.3.0 on the beta channel
    Given There is a release with channel "beta"
  ...
  Scenario: Updating an outdated ownCloud 10.2.1 on the beta channel
    Given There is a release with channel "beta"
